...
public class Insurance {
    ...
    @JsonIgnore // Ignoring the car field during JSON serialization
...
// private int insurance_ID;
// @Enumerated(EnumType.STRING)
// @Column(name = "coverage_type", unique = false, nullable = false, length =
// 200)
// private coverage_typeEnum coverage_type;
// @Enumerated(EnumType.STRING)
// @Column(name = "Insurance_company", unique = false, nullable = false, length
// = 200)
// private Insurance_companyEnum Insurance_company;
// @Column(name = "premium_amount", unique = false, nullable = false, length =
// 100)
// private int premium_amount;
